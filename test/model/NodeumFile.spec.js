...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.NodeumFile();
  });
  ...
  describe('NodeumFile', function() {
    it('should create an instance of NodeumFile', function() {
      // uncomment below and update the code to test NodeumFile
      //var instane = new NodeumSdk.NodeumFile();
      //expect(instance).to.be.a(NodeumSdk.NodeumFile);
    });
