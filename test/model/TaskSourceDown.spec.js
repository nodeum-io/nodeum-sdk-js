...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.TaskSourceDown();
  });
  ...
  describe('TaskSourceDown', function() {
    it('should create an instance of TaskSourceDown', function() {
      // uncomment below and update the code to test TaskSourceDown
      //var instane = new NodeumSdk.TaskSourceDown();
      //expect(instance).to.be.a(NodeumSdk.TaskSourceDown);
    });
