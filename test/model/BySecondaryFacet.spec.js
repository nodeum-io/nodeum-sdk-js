...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.BySecondaryFacet();
  });
  ...
  describe('BySecondaryFacet', function() {
    it('should create an instance of BySecondaryFacet', function() {
      // uncomment below and update the code to test BySecondaryFacet
      //var instane = new NodeumSdk.BySecondaryFacet();
      //expect(instance).to.be.a(NodeumSdk.BySecondaryFacet);
    });
