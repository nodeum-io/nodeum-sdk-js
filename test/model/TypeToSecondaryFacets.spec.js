...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.TypeToSecondaryFacets();
  });
  ...
  describe('TypeToSecondaryFacets', function() {
    it('should create an instance of TypeToSecondaryFacets', function() {
      // uncomment below and update the code to test TypeToSecondaryFacets
      //var instane = new NodeumSdk.TypeToSecondaryFacets();
      //expect(instance).to.be.a(NodeumSdk.TypeToSecondaryFacets);
    });
