...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.CloudBucket();
  });
  ...
  describe('CloudBucket', function() {
    it('should create an instance of CloudBucket', function() {
      // uncomment below and update the code to test CloudBucket
      //var instane = new NodeumSdk.CloudBucket();
      //expect(instance).to.be.a(NodeumSdk.CloudBucket);
    });
