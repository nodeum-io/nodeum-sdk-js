...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.ActiveJobStatus();
  });
  ...
  describe('ActiveJobStatus', function() {
    it('should create an instance of ActiveJobStatus', function() {
      // uncomment below and update the code to test ActiveJobStatus
      //var instane = new NodeumSdk.ActiveJobStatus();
      //expect(instance).to.be.a(NodeumSdk.ActiveJobStatus);
    });
