...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.SizeToDateFacets();
  });
  ...
  describe('SizeToDateFacets', function() {
    it('should create an instance of SizeToDateFacets', function() {
      // uncomment below and update the code to test SizeToDateFacets
      //var instane = new NodeumSdk.SizeToDateFacets();
      //expect(instance).to.be.a(NodeumSdk.SizeToDateFacets);
    });
