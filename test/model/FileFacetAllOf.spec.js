...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumApi.FileFacetAllOf();
  });
  ...
  describe('FileFacetAllOf', function() {
    it('should create an instance of FileFacetAllOf', function() {
      // uncomment below and update the code to test FileFacetAllOf
      //var instane = new NodeumApi.FileFacetAllOf();
      //expect(instance).to.be.a(NodeumApi.FileFacetAllOf);
    });
