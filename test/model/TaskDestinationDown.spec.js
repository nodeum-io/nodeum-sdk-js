...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.TaskDestinationDown();
  });
  ...
  describe('TaskDestinationDown', function() {
    it('should create an instance of TaskDestinationDown', function() {
      // uncomment below and update the code to test TaskDestinationDown
      //var instane = new NodeumSdk.TaskDestinationDown();
      //expect(instance).to.be.a(NodeumSdk.TaskDestinationDown);
    });
