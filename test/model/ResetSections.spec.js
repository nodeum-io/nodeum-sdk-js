...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.ResetSections();
  });
  ...
  describe('ResetSections', function() {
    it('should create an instance of ResetSections', function() {
      // uncomment below and update the code to test ResetSections
      //var instane = new NodeumSdk.ResetSections();
      //expect(instance).to.be.a(NodeumSdk.ResetSections);
    });
