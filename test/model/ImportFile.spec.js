...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.ImportFile();
  });
  ...
  describe('ImportFile', function() {
    it('should create an instance of ImportFile', function() {
      // uncomment below and update the code to test ImportFile
      //var instane = new NodeumSdk.ImportFile();
      //expect(instance).to.be.a(NodeumSdk.ImportFile);
    });
