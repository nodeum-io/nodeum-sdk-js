...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeumSdk.PrimaryScan();
  });
  ...
  describe('PrimaryScan', function() {
    it('should create an instance of PrimaryScan', function() {
      // uncomment below and update the code to test PrimaryScan
      //var instane = new NodeumSdk.PrimaryScan();
      //expect(instance).to.be.a(NodeumSdk.PrimaryScan);
    });
