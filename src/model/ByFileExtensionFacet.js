...
import ByFileExtensionFacetAllOf from './ByFileExtensionFacetAllOf';
...
class ByFileExtensionFacet {
    /**
     * Constructs a new <code>ByFileExtensionFacet</code>.
     * @alias module:model/ByFileExtensionFacet
     * @extends module:model/FileFacet
     * @implements module:model/FileFacet
     * @implements module:model/ByFileExtensionFacetAllOf
     */
    constructor() { 
        FileFacet.initialize(this);ByFileExtensionFacetAllOf.initialize(this);
        ByFileExtensionFacet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ByFileExtensionFacet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ByFileExtensionFacet} obj Optional instance to populate.
     * @return {module:model/ByFileExtensionFacet} The populated <code>ByFileExtensionFacet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ByFileExtensionFacet();
...
export default ByFileExtensionFacet;
