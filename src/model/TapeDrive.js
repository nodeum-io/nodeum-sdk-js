...
import TapeDriveAllOf from './TapeDriveAllOf';
import TapeDriveDevice from './TapeDriveDevice';

/**
 * The TapeDrive model module.
 * @module model/TapeDrive
 * @version 1.85.1
 */
class TapeDrive {
    /**
     * Constructs a new <code>TapeDrive</code>.
     * @alias module:model/TapeDrive
     * @extends module:model/TapeDriveDevice
     * @implements module:model/TapeDriveDevice
     * @implements module:model/TapeDriveAllOf
     */
    constructor() { 
        TapeDriveDevice.initialize(this);TapeDriveAllOf.initialize(this);
        TapeDrive.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TapeDrive</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TapeDrive} obj Optional instance to populate.
     * @return {module:model/TapeDrive} The populated <code>TapeDrive</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TapeDrive();
            TapeDriveDevice.constructFromObject(data, obj);
            TapeDriveDevice.constructFromObject(data, obj);
            TapeDriveAllOf.constructFromObject(data, obj);
 ...
 * @member {Number} id
 */
TapeDrive.prototype['id'] = undefined;

/**
 * @member {Number} tape_library_id
 */
TapeDrive.prototype['tape_library_id'] = undefined;

/**
 * @member {String} name
 */
TapeDrive.prototype['name'] = undefined;

/**
 * @member {String} comment
 */
TapeDrive.prototype['comment'] = undefined;

/**
 * @member {String} libso
 */
TapeDrive.prototype['libso'] = undefined;

/**
 * @member {Number} acs
 */
TapeDrive.prototype['acs'] = undefined;

/**
 * @member {Number} lsm
 */
TapeDrive.prototype['lsm'] = undefined;

/**
 * @member {Number} panel
 */
TapeDrive.prototype['panel'] = undefined;

/**
 * @member {Number} transport
 */
TapeDrive.prototype['transport'] = undefined;

/**
 * @member {module:model/TapeDrive.StatusEnum} status
 */
TapeDrive.prototype['status'] = undefined;

/**
 * @member {Number} full
 */
TapeDrive.prototype['full'] = undefined;

/**
 * @member {Number} mount_count
 */
TapeDrive.prototype['mount_count'] = undefined;

/**
 * @member {String} use_to
 */
TapeDrive.prototype['use_to'] = undefined;

/**
 * @member {String} use_by
 */
TapeDrive.prototype['use_by'] = undefined;

/**
 * @member {String} barcode
 */
TapeDrive.prototype['barcode'] = undefined;

/**
 * @member {Number} task_id
 */
TapeDrive.prototype['task_id'] = undefined;

/**
 * @member {Number} use_file_processed_size
 */
TapeDrive.prototype['use_file_processed_size'] = undefined;

/**
 * @member {Number} use_file_size_to_process
 */
TapeDrive.prototype['use_file_size_to_process'] = undefined;

/**
 * @member {String} use_file_name_processed
 */
TapeDrive.prototype['use_file_name_processed'] = undefined;

/**
 * @member {Number} bandwidth
 */
TapeDrive.prototype['bandwidth'] = undefined;


// Implement TapeDriveDevice interface:
/**
 * @member {String} serial
 */
TapeDriveDevice.prototype['serial'] = undefined;
/**
 * @member {Number} scsi_address
 */
TapeDriveDevice.prototype['scsi_address'] = undefined;
/**
 * @member {String} vendor
 */
TapeDriveDevice.prototype['vendor'] = undefined;
/**
 * @member {String} product
 */
TapeDriveDevice.prototype['product'] = undefined;
/**
 * @member {String} firmware
 */
TapeDriveDevice.prototype['firmware'] = undefined;
/**
 * When saved, device may be prefixed by *n* (eg. `/dev/nst5`)
 * @member {String} device
 */
TapeDriveDevice.prototype['device'] = undefined;
/**
 * @member {String} sgdevice
 */
TapeDriveDevice.prototype['sgdevice'] = undefined;
// Implement TapeDriveAllOf interface:
/**
 * @member {Number} id
 */
