...
/**
 * The StorageTapeByTypeFacets model module.
 * @module model/StorageTapeByTypeFacets
 * @version 1.86.0
 */
class StorageTapeByTypeFacets {
    /**
     * Constructs a new <code>StorageTapeByTypeFacets</code>.
     * @alias module:model/StorageTapeByTypeFacets
     */
    constructor() { 
        
        StorageTapeByTypeFacets.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StorageTapeByTypeFacets</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StorageTapeByTypeFacets} obj Optional instance to populate.
     * @return {module:model/StorageTapeByTypeFacets} The populated <code>StorageTapeByTypeFacets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StorageTapeByTypeFacets();
...
export default StorageTapeByTypeFacets;
