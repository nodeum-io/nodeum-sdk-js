...
import ByGroupOwnerFacetAllOf from './ByGroupOwnerFacetAllOf';
...
class ByGroupOwnerFacet {
    /**
     * Constructs a new <code>ByGroupOwnerFacet</code>.
     * @alias module:model/ByGroupOwnerFacet
     * @extends module:model/FileFacet
     * @implements module:model/FileFacet
     * @implements module:model/ByGroupOwnerFacetAllOf
     */
    constructor() { 
        FileFacet.initialize(this);ByGroupOwnerFacetAllOf.initialize(this);
        ByGroupOwnerFacet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ByGroupOwnerFacet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ByGroupOwnerFacet} obj Optional instance to populate.
     * @return {module:model/ByGroupOwnerFacet} The populated <code>ByGroupOwnerFacet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ByGroupOwnerFacet();
...
export default ByGroupOwnerFacet;
