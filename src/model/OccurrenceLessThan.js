...
/**
 * The OccurrenceLessThan model module.
 * @module model/OccurrenceLessThan
 * @version 1.88.0
 */
class OccurrenceLessThan {
    /**
     * Constructs a new <code>OccurrenceLessThan</code>.
     * Must have less than %{count} occurrences (currently have %{value})
     * @alias module:model/OccurrenceLessThan
    ...
    constructor(error) { 
        ...
        OccurrenceLessThan.initialize(this, error);
    }
    ...
    /**
     * Constructs a <code>OccurrenceLessThan</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OccurrenceLessThan} obj Optional instance to populate.
     * @return {module:model/OccurrenceLessThan} The populated <code>OccurrenceLessThan</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OccurrenceLessThan();
 ...
 * @member {Number} count
 */
OccurrenceLessThan.prototype['count'] = undefined;

/**
 * Current number of occurrences
 * @member {Number} value
 */
OccurrenceLessThan.prototype['value'] = undefined;
...
export default OccurrenceLessThan;
